...
df1 = pd.read_csv('C:\PhonePe Pulse\pulse-master\india_map.csv')

# Read the "Bar_chart" CSV file into a DataFrame
df2 = pd.read_csv('C:\PhonePe Pulse/agg_user.csv')

# Read the "Histogram_district" CSV file into a DataFrame :
df3 = pd.read_csv('C:\PhonePe Pulse\map_trans.csv')

# Read the "Histogram_state" CSV file into a DataFrame :
df4 = pd.read_csv('C:\PhonePe Pulse\pulse-master/violin_plot.csv')
